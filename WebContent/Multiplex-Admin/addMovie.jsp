...
<!-- Page header -->
            ...
            <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
	                <li class="active"><a href="#inside" data-toggle="tab"><i class="icon-checkbox-partial"></i>Add Movie</a></li>
                </ul>
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Add Movies</h6></div>
				                    ...
				                    <tbody>
				                    	...
				                    	<tr>
				                    		...
				                    		<td>	
				                        	 ...
				                        	 <a href="<%=request.getContextPath()%>/movieController?flag=add_movie&theatre_id=${i.theatre_id}">Add Movie</a>
