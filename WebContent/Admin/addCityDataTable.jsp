				...
				<div class="row">
					<div class="col-md-2">
						<div class="list-group">
							...
							<a href="javascript:void(0)" class="list-group-item">Add_State Datatable</a>
							<a href="addCityDataTable.jsp" class="active list-group-item">Add_City Datatable</a>
						</div>
					</div>
					<div class="col-md-10">
						<div style="position: relative;"
							...
							<table style="width: 100%;"
								...
								<thead>
									<tr role="row">
									<th aria-label="City Id: activate to sort column ascending"
											aria-sort="ascending" style="width: 145px;" colspan="1"
											rowspan="1" aria-controls="datatable_demo" tabindex="0"
											class="sorting_asc">City Id</th>
									
									
										<th aria-label="Country Name: activate to sort column ascending"
											aria-sort="ascending" style="width: 145px;" colspan="1"
											rowspan="1" aria-controls="datatable_demo" tabindex="0"
											class="sorting_asc">Country Name</th>
											<th aria-label="State Name: activate to sort column ascending"
											aria-sort="ascending" style="width: 145px;" colspan="1"
											rowspan="1" aria-controls="datatable_demo" tabindex="0"
											class="sorting_asc">State Name</th>
											<th aria-label="City Name: activate to sort column ascending"
											aria-sort="ascending" style="width: 145px;" colspan="1"
											rowspan="1" aria-controls="datatable_demo" tabindex="0"
											class="sorting_asc">City Name</th>
										<th aria-label="City Description: activate to sort column ascending"
											style="width: 238px;" colspan="1" rowspan="1"
											aria-controls="datatable_demo" tabindex="0" class="sorting">City Description</th>
										
									</tr>
								</thead>
								<tbody>
<sql:setDataSource driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost/showcasa" user="root" password="root" var="c"/>
<sql:query var="j" dataSource="${c}">Select * from add_city_vo </sql:query>
<c:forEach items="${j.rows}" var="i">
<tr class="odd" role="row">

										<td class="sorting_1">${i.CITY_ID }</td>
