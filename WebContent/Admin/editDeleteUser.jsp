...
<%@include file="header.jsp" %>
            ...
            <nav id="breadcrumbs">
                <ul>
                    <li><a href="<%=request.getContextPath() %>/userRegistrationController?flag=search_user">Manage User</a></li>        </ul>
            </nav>
				                ...
				                <table class="table">
				                    ...
				                    <tbody>
				                    	...
				                    	<tr>
				                            ...
				                            <a href="<%=request.getContextPath()%>/userRegistrationController?flag=edit_user&user_id=${i.user_id}">EDIT</a> 
											/ <a href="<%=request.getContextPath()%>/userRegistrationController?flag=delete_user&user_id=${i.user_id}">DELETE</a>	
