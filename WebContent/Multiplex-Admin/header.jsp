<header id="main_header">
                <div class="container-fluid">
                    <div class="brand_section">
                        <a href="dashboard.jsp"><img src="img/logo3.png" alt="Showcasa Admin" width="63" height="47"></a>
                    </div>
                     ...
                     --><div class="header_user_actions dropdown">
                        <div data-toggle="dropdown" class="dropdown-toggle user_dropdown">
                            <div class="user_avatar">
                                <img src="img/avatar05_tn.png" alt="" title="Carrol Clark (carrol@example.com)" width="38" height="38">
                            </div>
                            <span class="caret"></span>
                        </div>
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a href="pages-user_profile2.html">Settings</a></li>
                            <li><a href="../admin/adminLogin.jsp?flag=logout">Log Out</a></li>
                        </ul>
                    </div>
