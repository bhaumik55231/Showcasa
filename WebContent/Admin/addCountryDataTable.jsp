				...
				<div class="row">
					<div class="col-md-2">
						<div class="list-group">
							...
							<a href="javascript:void(0)" class="active list-group-item">Add_Country Datatable</a>
						...
						<div style="position: relative;"
							...
							<table style="width: 100%;"
								...
								<thead>
									...
									<th aria-label="Country Id: activate to sort column ascending"
											aria-sort="ascending" style="width: 145px;" colspan="1"
											rowspan="1" aria-controls="datatable_demo" tabindex="0"
											class="sorting_asc"><span class="arrow_up-down_alt bs_ttip"></span>Country Id</th>
									
										<th aria-label="First Name: activate to sort column ascending"
											aria-sort="ascending" style="width: 145px;" colspan="1"
											rowspan="1" aria-controls="datatable_demo" tabindex="0"
											class="sorting_asc"><span class="arrow_up-down_alt bs_ttip"></span>Country Name</th>
										<th aria-label="Last Name: activate to sort column ascending"
											style="width: 238px;" colspan="1" rowspan="1"
											aria-controls="datatable_demo" tabindex="0" class="sorting"><span class="arrow_up-down_alt bs_ttip"></span>Country Description</th>
...
<sql:query var="j" dataSource="${c}">Select * from add_country_vo </sql:query>
<c:forEach items="${j.rows}" var="i"> --%>
<tr class="odd" role="row">

										<td class="sorting_1">Raven</td>
										<td>HH</td>
										<td>LL</td>
										
										
									</tr>
									<tr><td class="sorting_1">Raven</td>
										<td>HH</td>
										<td>LL</td></tr>
										<tr><td class="sorting_1">Raven</td>
										<td>HH</td>
										<td>LL</td></tr>
										<tr><td class="sorting_1">PPven</td>
										<td>HH</td>
										<td>LL</td></tr>
										<tr><td class="sorting_1">Raven</td>
										<td>HH</td>
										...
										<tr><td class="sorting_1">Raven</td>
										<td>HH</td>
										<td>LL</td></tr><tr><td class="sorting_1">Raven</td>
										<td>HH</td>
										<td>LL</td></tr>
										<tr><td class="sorting_1">Raven</td>
										<td>HH</td>
