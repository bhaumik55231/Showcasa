...
function init_BookingOne() {
	...
	//6. Choose variant proccess
                ...
                $('.time-select__item').click(function (){
                    ...
                    //data element init
                    var chooseTime2 = $(this).attr('data-time');
                    //s = '<input type="text" name="textbox'+1+'" value="'+chooseTime2+'" >';
            		document.getElementById('put_here').innerHTML = s;
                    ...
                    if(! $(e.target).hasClass('sits-state--your')){
                        ...
                        if (! $(this).hasClass('sits-state--not') ) {
                           ...
                           /* switch(ticketPrice)
                            ...
                            sum=sum+parseInt(ticketPrice); //CHANGE#1: COMMENTED THE SWITCH AND ADDED THIS STATEMENT
                            sum_place=sum_place.concat(place);
                            $('.checked-result').text('Rs' +sum);
                           //$('.show-result').text(sum_place+sum);
                            
                            gen_count=gen_count+1;
                            if(gen_count==1)
                            	{
                            		//s = '<input type="hidden" name="textbox'+1+'" value="'+place+'" >';
                            		document.getElementById('screens1').innerHTML = s;
                            	}
                            else if(gen_count==2)
                        	{
                        		//s = '<input type="hidden" name="textbox'+2+'" value="'+place+'" >';
                        		document.getElementById('screens2').innerHTML = s;
                        	}
                            else
                            	{
                            		//$('.screens001').text(sum_place+sum);
                            	}
                        ...
                        sum=sum-parseInt(ticketPrice); //CHANGE#2: COMMENTED THE SWITCH AND ADDED THIS STATEMENT
                        
                        sum_place = sum_place.replace(place, '');
                        $('.checked-result').text('Rs'+sum);
                        //$('.show-result').text(sum_place+sum);
                    }
