...
<%@include file="header.jsp" %>
            ...
            <nav id="breadcrumbs">
                <ul>
                    <li><a href="admin_userregistration.jsp.jsp">User Forget Password</a></li>        </ul>
            </nav>
	...
	<form class="form-horizontal">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="password" class="form-control" placeholder="Re-enter New Password" name="reenterconfirmpassword" required="">
	    </div>
	  </div>
