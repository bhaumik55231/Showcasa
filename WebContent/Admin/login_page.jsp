...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Showcasa Admin login page</title>
    ...
    <body class="login_page">
        ...
        <div class="login_header">
            <a href="admin.jsp"><img src="img/logo.png" alt="site_logo"></a>
        </div>
            ...
            <div class="form_wrapper animated-short" id="login_form">
                ...
                <form action="">
                    ...
                    <div class="form-group sepH_c">
                        <a href="dashboard.html" class="btn btn-lg btn-primary btn-block">Log in</a>
                    </div>
                </form>
            </div>
