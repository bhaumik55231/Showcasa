...
-->
	...
	<div id="main_wrapper">
	<blockquote>
	<h3><strong>Add Item Agent</strong></h3>
	...
	<% 	
							...
							if(request.getParameter("flag")!=null)
							{
								...
								if(i.equals("success"))
								{
									...
									code = code + "<strong>  Item Agent Added.</strong></div>";
								}
								else
								{
						...
						%>
						<%=code %>			
	<form class="form-horizontal" action="<%=request.getContextPath()%>/itemController1" method="post">
	 
						  <div class="form-group">
						    <label class="col-sm-2 control-label">Enter Username</label>
						    <div class="col-sm-10">
						      <input type="text" class="form-control " placeholder="Enter Item Agent Username" name="username" required>
						    </div>
						  </div>
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-10">
						      <input type="text" class="form-control " placeholder="Enter Password Again" name="c_password" required>
						    </div>
						  </div>
					
	  <div class="form-actions text-center">
	  <input type="hidden" name="flag" value="add_item_agent">
