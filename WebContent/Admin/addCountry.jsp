...
<%@include file="header.jsp" %>
            ...
            <nav id="breadcrumbs">
                <ul>
                    <li><a href="addCountry.jsp">Add Country</a></li>        </ul>
            </nav>
	...
	<div class="page-title">
					<h3> Add Country </h3><br>
				</div>
	<form class="form-horizontal" action="<%=request.getContextPath()%>/countryController" method="post" onsubmit="return Validation()">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control " placeholder="Enter Country Name" id="countryname" name="CountryName" required="">
	    </div>
	  </div>
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	     <textarea cols="30" rows="5" name="CountryDescription" placeholder="Enter Country Description" class="form-control"></textarea>
	    </div>
	  </div>
