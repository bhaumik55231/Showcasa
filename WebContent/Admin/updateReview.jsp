...
<%@include file="header.jsp" %>
            ...
            <nav id="breadcrumbs">
                <ul>
                    <li><a href="addCountry.jsp">Search Country</a></li>        </ul>
            </nav>
	...
	<div id="main_wrapper">
            ...
            <c:forEach items="${sessionScope.edit_review }" var="x">
			
				                        
            <form class="form-horizontal validate" action="<%=request.getContextPath()%>/reviewMovieController" method="post" >
	            <div class="block">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="ReviewMovieName" id="CountryName" value="${x.review_movie_name }">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="ReviewDescription" class="required form-control" >${x.review_description }</textarea>
						</div>
					</div>

					<input type="hidden" name="ReviewId" value="${x.review_id }"> 
					<input type="hidden" name="flag" value="update_review"> 
			
                   <div class="form-actions text-center">
                    	<input type="submit" value="Update Review" class="btn btn-success">
