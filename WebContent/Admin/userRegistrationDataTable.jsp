				...
				<div class="row">
					<div class="col-md-2">
						<div class="list-group">
							...
							<a href="javascript:void(0)" class="active list-group-item">User_Registration Datatable</a>
							<a href="addCountryDataTable.jsp" class="list-group-item">Add_Country Datatable</a>
							<a href="addStateDataTable.jsp" class="list-group-item">Add_State Datatable</a>
							...
							<table style="width: 100%;"
								...
								<thead>
									...
									<th aria-label="User Id: activate to sort column ascending"
											...
											class="sorting_asc">User Id</th>
									
										<th aria-label="First Name: activate to sort column ascending"
											aria-sort="ascending" style="width: 145px;" colspan="1"
											rowspan="1" aria-controls="datatable_demo" tabindex="0"
											class="sorting_asc">First Name</th>
										<th aria-label="Last Name: activate to sort column ascending"
											style="width: 238px;" colspan="1" rowspan="1"
											aria-controls="datatable_demo" tabindex="0" class="sorting">Last Name</th>
										<th aria-label="Email-Id: activate to sort column ascending"
											style="width: 110px;" colspan="1" rowspan="1"
											aria-controls="datatable_demo" tabindex="0" class="sorting">Email-Id</th>
										<th aria-label="Mobile No.: activate to sort column ascending"
											style="width: 42px;" colspan="1" rowspan="1"
											aria-controls="datatable_demo" tabindex="0" class="sorting">Mobile No.</th>
										<th aria-label="Country: activate to sort column ascending"
											style="width: 94px;" colspan="1" rowspan="1"
											aria-controls="datatable_demo" tabindex="0" class="sorting">Country</th>
										<th aria-label="State: activate to sort column ascending"
											style="width: 86px;" colspan="1" rowspan="1"
											aria-controls="datatable_demo" tabindex="0" class="sorting">State</th>
											<th aria-label="City: activate to sort column ascending"
											style="width: 86px;" colspan="1" rowspan="1"
											aria-controls="datatable_demo" tabindex="0" class="sorting">City</th>
											<th aria-label="Gender: activate to sort column ascending"
											style="width: 86px;" colspan="1" rowspan="1"
											aria-controls="datatable_demo" tabindex="0" class="sorting">Gender</th>
											<th aria-label="Password: activate to sort column ascending"
											style="width: 86px;" colspan="1" rowspan="1"
											aria-controls="datatable_demo" tabindex="0" class="sorting">Password</th>
...
<sql:setDataSource driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost/showcasa" user="root" password="root" var="c"/>
<sql:query var="j" dataSource="${c}">Select * from user_registration_vo </sql:query>
...
<tr class="odd" role="row">
										...
										<td class="sorting_1">${i.USER_ID}</td>
										<td>${i.FIRST_NAME}</td>
										<td>${i.LAST_NAME}</td>
										<td>${i.EMAIL_ID}</td>
