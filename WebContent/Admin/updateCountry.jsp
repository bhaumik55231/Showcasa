...
<%@include file="header.jsp" %>
            ...
            <nav id="breadcrumbs">
                <ul>
                    <li><a href="addCountry.jsp">Update Country</a></li>        </ul>
            </nav>
	...
	<div id="main_wrapper">
            ...
            <form class="form-horizontal validate" action="<%=request.getContextPath()%>/countryController" method="post" onsubmit="return Validation()">
	            <div class="block">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="CountryName" required="" id="countryname" value="${x.country_name }">
						</div>
					</div>
