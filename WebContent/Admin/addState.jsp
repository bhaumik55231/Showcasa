...
<%@include file="header.jsp" %>
            ...
            <nav id="breadcrumbs">
                <ul>
                    <li><a href="<%=request.getContextPath() %>/stateController?flag=search_country_for_state">Add State</a></li>        </ul>
            </nav>
...
<!-- Form validation -->
            <form class="form-horizontal validate" action="<%=request.getContextPath() %>/stateController" method="post" onsubmit="return Validation()">
	            <div class="block">
	                <h6 class="heading-hr"><i class="icon-checkmark-circle"></i> </h6>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input placeholder="Enter State Name" type="text" class="required form-control" name="StateName" id="statename" required="">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" placeholder="State Description" name="StateDescription" class="required form-control" ></textarea>
						</div>
					</div>
