...
<%@include file="header.jsp" %>
            ...
            <nav id="breadcrumbs">
                <ul>
                    <li><a href="<%=request.getContextPath() %>/reviewMovieController?flag=search_review">Search Review</a></li>        </ul>
            </nav>
			            ...
			            <div class="panel panel-default">
			                ...
			                <div class="datatable-add-row">
				                <table class="table table-striped table-bordered table-hover" id="dataTables-example"> 
				                    ...
				                    <tbody>
				                        <c:forEach items="${sessionScope.search_review }" var="i">
				                        	<tr>
				                        		<td>${i.review_id}</td>
				                        		<td>${i.movie_id}</td>
				                        		<td>${i.review_description}</td>
				                        		<td>	
				                            
				                            		<%--<a href="<%=request.getContextPath()%>/reviewMovieController?flag=edit_review&review_id=${i.review_id}">EDIT</a> --%> 
												   <a href="<%=request.getContextPath()%>/reviewMovieController?flag=delete_review&review_id=${i.review_id}">DELETE</a>	
...
<!-- DataTables JavaScript -->
    ...
    <script src="css/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.min.js"></script>
            <script>
                $(function() {
                    // c3 charts
