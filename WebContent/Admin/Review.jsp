...
<%@include file="header.jsp" %>
	...
	<div id="main_wrapper">
	<form class="form-horizontal" action="<%=request.getContextPath()%>/reviewMovieController" method="post">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control " placeholder="Enter Country Name" name="ReviewMovieName" required="">
	    </div>
	  </div>
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	     <textarea cols="30" rows="5" name="ReviewDescription" placeholder="Enter Country Description" class="form-control"></textarea>
	    </div>
	  </div>
	  
	 <input type="hidden" name="flag" value="add_review"> 
