...
<html>
    <head>
		<meta charset="UTF-8">
		<title>Showcasa Admin (pages-mailbox_compose)</title>
        ...
        <!-- page specific stylesheets -->
            ...
            <!-- summernote -->
            <link href="css/summernote.css" rel="stylesheet" media="all">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-3 col-lg-2">
                            <span class="btn btn-primary btn-outline btn-sm">Compose</span>
                            <hr/>
                        ...
                        <div class="col-md-9 col-lg-10">
                            <form action="">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="mail_to">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="mail_subject" placeholder="Add subject">
                                </div>
                                <div class="form-group">
                                    <div id="wysiwyg_compose"></div>
                                </div>
                                <hr/>
                                <button class="btn btn-sm btn-success"><span class="el-icon-upload"></span> Send</button>
                    ...
                    <ul>
                        ...
                        <li class="first_level">
                            ...
                            <ul>
                                ...
                                <li><a class="act_nav" href="mailbox_compose.jsp">Mailbox (compose)</a></li>
