...
<body class="side_menu_active side_menu_expanded">
	<div id="page_wrapper">
		...
		<ul>
			<li><a
				href="<%=request.getContextPath()%>/multiplexAdminController?flag=search_multiplex_admin">Search
					Multiplex Admin</a></li>
		</ul>
		</nav>
		...
		<div id="main_wrapper">
			...
			<div class="tabbable page-tabs">
				<ul class="nav nav-tabs">
					<li class="active"><a href="#inside" data-toggle="tab"><i
							class="icon-checkbox-partial"></i> Search City</a></li>
				</ul>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h6 class="panel-title">
									<i class="icon-table"></i> Edit &amp; Delete City
								</h6>
							</div>
									...
									<tbody>
										...
										<c:forEach items="${sessionScope.search_user }" var="i">
											<tr>
												...
												<td>${i.password }</td>
												<td>${i.admin_name }</td>
												<td>${i.multiplex_name }</td>


												<td>${i.timestamp }</td>

												<td><a
													href="<%=request.getContextPath()%>/multiplexAdminController?flag=delete_user&user_id=${i.id}">DELETE</a>
