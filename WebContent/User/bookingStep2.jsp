...
<head>
	<!-- Basic Page Needs -->
        <meta charset="utf-8">
        <title>Showcasa - Booking step 2</title>
...
<c:choose>
	<c:when test="${ empty sessionScope.task_done}">
		<%response.sendRedirect("../paymentController?flag=load_seat&show_id="+show_id);%> 
	</c:when>
	<c:otherwise> 
       ...
       %>
        ...
        <section class="container">
            ...
            <div class="choose-sits__info choose-sits__info--first">
                    <ul>
                        <li class="sits-price marker--none"><strong>Date</strong></li>
                        <li class="sits-price sits-state--not"><%= session.getAttribute("select_date") %></li>
                 ...
                 <div class="choose-sits__info choose-sits__info--first">
                    <ul>
                        <li class="sits-price marker--none"><strong>Movie</strong></li>
                        <li class="sits-price sits-state--your"><%= session.getAttribute("select_movie") %></li>
                 ...
                 <div class="choose-sits__info choose-sits__info--first">
                    <ul>
                        <li class="sits-price marker--none"><strong>Show Time</strong></li>
                        <li class="sits-price sits-state--not"><%= session.getAttribute("select_hr") %> : <%=session.getAttribute("select_min") %> </li>
                ...
                <div class="choose-sits__info choose-sits__info--first">
                    <ul>
                        ...
                        <li class="sits-price sits-price--cheap"><%= session.getAttribute("price1") %></li>
                        <li class="sits-price sits-price--middle"><%= session.getAttribute("price2") %></li>
                        <li class="sits-price sits-price--expensive"><%= session.getAttribute("price3") %></li>
                    </ul>
                </div>
...
<%
session.setAttribute("price_cheap","100");
List<String> list =(List<String>) session.getAttribute("booked");
%>

   
                            <%--<div class="sits__row"> --%>
                            
                            <%=session.getAttribute("put_seat") %>
                            <%--<c:forEach var='i' begin='0' end='15'>
                           
<span class="sits__place sits-price--cheap " data-place='A<c:out value="${i+2}"/>' data-price='<c:out value='<%= session.getAttribute("price_cheap") %>'/>'>A<c:out value="${i+2}"/></span>
							</c:forEach>
							 --%>
							 
                                <%-- <span class="sits__place sits-price--cheap" data-place='A2' data-price='100'>A2</span>
                                <span class="sits__place sits-price--cheap" data-place='A3' data-price='100'>A3</span>
            ...
            <div class="col-sm-12 visible-xs"> 
                <div class="sits-area--mobile">
                    <div class="sits-area--mobile-wrap">
                        <div class="sits-select">
                            <select name="sorting_item" class="sits__sort sit-row" tabindex="0">
                                    <option value="1" selected='selected' data-price='100'>A</option>
                            ...
                            <select name="sorting_item" class="sits__sort sit-number" tabindex="1">
                                    <option value="1" selected='selected' data-price='100'>1</option>
                    ...
                    <img alt="" src="img/sits_mobile.png">
        ...
        <form action="<%=request.getContextPath()%>/paymentController" method="post" id="form03">
         <div id="a">
      
        </div>
        <div class="screens001" id="screens1">
                </div>
         <div id="screens2">
        
        </div>    <%-- <%=session.getAttribute("booked")%>  --%>
        <input type='hidden' name='choosen-sits' class="choosen-sits">
        
         <input type='hidden' name='choosen-cost' class="choosen-cost">
         <input type="hidden" name="flag" value="choosen_tickets">
		<!-- <input type="submit" value="Submit"> -->
		</form>
        <div class="clearfix"></div>
        <form id="form01" class="booking-form" method="get" action="bookingStep3(buy).jsp">
            ...
            <div class="booking-pagination booking-pagination--margin">
                    <a href="bookingStep1.jsp" class="booking-pagination__prev">
                        <span class="arrow__text arrow--prev">prev step</span>
                        <span class="arrow__info">what&amp;where&amp;when</span>
                    </a>
                   <a onclick="document.getElementById('form03').submit();" href="#" 
       class="booking-pagination__next">
