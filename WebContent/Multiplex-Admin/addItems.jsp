...
<!-- Page header -->
            ...
            <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
	                <li class="active"><a href="#inside" data-toggle="tab"><i class="icon-checkbox-partial"></i> Add Items</a></li>
                </ul>
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Add Items Theatrewise</h6></div>
				                    ...
				                    <tbody>
				                    	...
				                    	<tr>
				                    		...
				                    		<td>	
				                        	 ...
				                        	 <a href="<%=request.getContextPath()%>/itemController?flag=get_form&user_id=${i.theatre_id}">Add Items</a>
