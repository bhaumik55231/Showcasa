...
<html>
<%-- <%= hash %> --%>
 <!--  9082e6f8d1c5d3868a49fb4395694fcb925c9051e57b09b7023be023400755e5b28cb2b436af6ccf20e96c1eec214a3b6429c5d8cbdaed5bbb786b6545566eac -->
<script>
...
<input type="hidden" name="key" value="<%= merchant_key %>" />
      ...
      <table>
        ...
        <tr>
          <!-- <td>Amount: </td> -->
          <td><input name="amount" value="<%=session.getAttribute("payu_amount")%>" type="hidden"/></td>
          <!-- <td>First Name: </td> -->
          <td><input name="firstname" id="firstname" value="<%=session.getAttribute("payu_fname")%>" type="hidden"/></td>
        </tr>
        <tr>
         <!--  <td>Email: </td> -->
          <td><input name="email" id="email" value="<%=session.getAttribute("payu_email")%>" type="hidden" /></td>
         <!--  <td>Phone: </td> -->
          <td><input name="phone" value="<%=session.getAttribute("payu_pnum")%>" type="hidden"/></td>
        </tr>
        <tr>
          <!-- <td>Product Info: </td> -->
          <td colspan="3"><input name="productinfo" value="<%=session.getAttribute("payu_pinfo")%>" size="64" type="hidden" /></td>
        </tr>
        <tr>
          <!-- <td>Success URI: </td> -->
          <td colspan="3"><input name="surl" value="<%=session.getAttribute("payu_surl")%>" size="64" type="hidden"/></td>
        </tr>
        <tr>
          <!-- <td>Failure URI: </td> -->
          <td colspan="3"><input name="furl" value="<%=session.getAttribute("payu_furl")%>" size="64" type="hidden"/></td>
        </tr>
        <tr>
