       ...
       %>
        ...
        <section class="container">
            ...
            <div class="col-sm-12">
                ...
                <div class="order">
                    <a href="bookingFinal.jsp" class="btn btn-md btn--warning btn--wide">purchase</a>
                </div>
...
<% String g=request.getParameter("choosen-sits");
out.println(g);
%>
        <div class="booking-pagination">
                <a href="bookingStep2.jsp" class="booking-pagination__prev">
