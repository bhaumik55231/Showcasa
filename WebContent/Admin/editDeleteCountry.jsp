				                        ...
				                        <c:forEach items="${sessionScope.search_country }" var="i">
				                        	<tr>
				                        		...
				                        		<td>	
				                            		...
				                            		<a href="<%=request.getContextPath()%>/countryController?flag=edit_country&country_id=${i.country_id}">EDIT</a> 
												   /<a href="<%=request.getContextPath()%>/countryController?flag=delete_country&country_id=${i.country_id}">DELETE</a>	
