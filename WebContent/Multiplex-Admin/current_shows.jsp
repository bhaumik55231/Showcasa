            ...
            <div id="main_wrapper">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                        <blockquote>
                        <h2><strong>Current Shows</strong></h2>
                        <p><strong><%=session.getAttribute("select_theatre_name") %></strong>
                        <p><strong>Screen: <%=session.getAttribute("select_screen_id") %></strong>
                        </blockquote>
						<% 	
							String code = "";
							if(request.getParameter("flag")!=null)
							{
								...
								if(i.equals("success"))
								{
									...
									code = code + "<strong>  Show Deleted.</strong></div>";
								}
								else
								{
                                 ...
                                 <thead>
				                    ...
				                    <tbody>
				                    	...
				                    	<tr>
				                    		<td>${i.show_id }</td>
				                    		<td>${i.movie_name }</td>
				                    		<td>${i.start_hr} : ${i.start_min }</td>
				                    		<td>${i.start_date } / ${i.start_month } / ${i.start_year }</td>
				                    		<td>	
				                            
				                        	 <a class="btn btn-danger" href="<%=request.getContextPath()%>/showController?flag=suspend&source=current_show&screen_id=${i.show_id}">Suspend</a>
